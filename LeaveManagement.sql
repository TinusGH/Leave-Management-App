...
/****** Object:  Database [LeaveManagement]    Script Date: 2023/09/23 22:44:48 ******/
CREATE DATABASE [LeaveManagement]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'LeaveManagement', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\LeaveManagement.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'LeaveManagement_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\LeaveManagement_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
